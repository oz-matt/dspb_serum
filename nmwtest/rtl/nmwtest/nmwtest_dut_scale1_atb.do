...
if {! [file exists $base_dir/nmwtest_dut_scale1]} {
    file delete -force $base_dir/nmwtest_dut_scale1
}

project new $base_dir nmwtest_dut_scale1
...
if {[info exists quartus_dir] && [file isdirectory $quartus_dir]} {
    ...
    do "$base_dir/nmwtest/nmwtest_dut_scale1_fpc.do"
} else {
...
vcom -quiet -O0 $base_dir/nmwtest/nmwtest_dut_scale1_atb.vhd
vcom -quiet $base_dir/nmwtest/nmwtest_dut_scale1_stm.vhd
...
if {$vcomfailed == 0} {
    ...
    vsim -quiet -error 3473 -msgmode both -voptargs="+acc" -t ps nmwtest_dut_scale1_atb 
    do $base_dir/nmwtest/nmwtest_dut_scale1_atb.wav.do
